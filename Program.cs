...
public class Program
{
    ...
    private const string blobServiceEndpoint = "https://mediastor38804726.blob.core.windows.net/";
    //Update the storageAccountName value that you recorded previously in this lab.
    private const string storageAccountName = "mediastor38804726";
    //Update the storageAccountKey value that you recorded previously in this lab.
    private const string storageAccountKey = "C3vna40PQ2WJGmsiiOVr9nrzJ3IMcZQxOOBnO2qKMk4bTHlAISrbs+LNCQ3AUG1B1zyW4EyjZbEB+AStfhPXRg==";    
